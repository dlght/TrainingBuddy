...
values
  ...
  ('incline-dumbbell-press', 'Incline Dumbbell Press', 'chest', 'dumbbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/incline-dumbbell-press.jpg',
  ...
  ('barbell-squat', 'Barbell Squat', 'legs', 'barbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/barbell-squat.jpg',
  ...
  ('chest-supported-dumbbell-row', 'Chest Supported Dumbbell Row', 'back', 'dumbbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/chest-supported-dumbbell-row.jpg',
  ...
  ('seated-leg-curl', 'Seated Leg Curl', 'legs', 'machine', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/seated-leg-curl.jpg',
  ...
  ('dumbbell-incline-curl', 'Dumbbell Incline Curl', 'arms', 'dumbbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/dumbbell-incline-curl.jpg',
  ...
  ('dumbbell-overhead-triceps-extension', 'Dumbbell Overhead Triceps Extension', 'arms', 'dumbbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/dumbbell-overhead-triceps-extension.jpg',
  ...
  ('behind-body-cable-curl', 'Behind-the-Body Cable Curl', 'arms', 'cable', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/behind-body-cable-curl.jpg',
  ...
  ('rope-overhead-triceps-extension', 'Rope Overhead Triceps Extension', 'arms', 'cable', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/rope-overhead-triceps-extension.jpg',
  ...
  ('barbell-bench-press', 'Barbell Bench Press', 'chest', 'barbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/barbell-bench-press.jpg',
  ...
  ('romanian-deadlift', 'Romanian Deadlift', 'legs', 'barbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/romanian-deadlift.jpg',
  ...
  ('lat-pulldown', 'Lat Pulldown', 'back', 'cable', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/lat-pulldown.jpg',
  ...
  ('walking-lunges', 'Walking Lunges', 'legs', 'bodyweight', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/walking-lunges.jpg',
  ...
  ('behind-body-cable-lateral-raise', 'Behind-the-Body Cable Lateral Raise', 'shoulders', 'cable', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/behind-body-cable-lateral-raise.jpg',
  ...
  ('reverse-crunch', 'Reverse Crunch', 'core', 'bodyweight', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/reverse-crunch.jpg',
  ...
  ('seated-dumbbell-shoulder-press', 'Seated Dumbbell Shoulder Press', 'shoulders', 'dumbbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/seated-dumbbell-shoulder-press.jpg',
  ...
  ('one-arm-dumbbell-row', 'One-Arm Dumbbell Row', 'back', 'dumbbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/one-arm-dumbbell-row.jpg',
  ...
  ('barbell-hip-thrust', 'Barbell Hip Thrust', 'legs', 'barbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/barbell-hip-thrust.jpg',
  ...
  ('dumbbell-step-up', 'Dumbbell Step-Up', 'legs', 'dumbbell', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/dumbbell-step-up.jpg',
  ...
  ('leg-extension', 'Leg Extension', 'legs', 'machine', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/leg-extension.jpg',
  ...
  ('seated-cable-chest-fly', 'Seated Cable Chest Fly', 'chest', 'cable', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/seated-cable-chest-fly.jpg',
  ...
  ('standing-calf-raise', 'Standing Calf Raise', 'legs', 'machine', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/standing-calf-raise.jpg',
  ...
  ('reverse-cable-fly', 'Reverse Cable Fly', 'shoulders', 'cable', 'https://xchfgfceaxizeiqfrnjz.supabase.co/storage/v1/object/public/exercise-images/processed/reverse-cable-fly.jpg',
...
insert into public.badges (id, category, threshold, label) values
  ('lifetime-workouts-10', 'lifetime_workouts', 10, '10 workouts'),
  ('lifetime-workouts-50', 'lifetime_workouts', 50, '50 workouts'),
  ('lifetime-workouts-100', 'lifetime_workouts', 100, '100 workouts'),
  ('lifetime-workouts-200', 'lifetime_workouts', 200, '200 workouts'),
  ('lifetime-workouts-500', 'lifetime_workouts', 500, '500 workouts'),
  ('lifetime-workouts-1000', 'lifetime_workouts', 1000, '1000 workouts'),
  ('streak-1', 'streak', 1, '1 day streak'),
  ('streak-2', 'streak', 2, '2 day streak'),
  ('streak-3', 'streak', 3, '3 day streak'),
  ('streak-5', 'streak', 5, '5 day streak'),
  ('streak-7', 'streak', 7, '7 day streak'),
  ('streak-10', 'streak', 10, '10 day streak'),
  ('streak-14', 'streak', 14, '14 day streak'),
